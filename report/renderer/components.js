...
function create3pFilterComponent(dom) {
  ...
  v1.append(dom.document().createTextNode(' .lh-3p-filter { background-color: var(--table-higlight-background-color); color: var(--color-gray-600); float: right; padding: 6px; } .lh-3p-filter-label, .lh-3p-filter-input { vertical-align: middle; user-select: none; } .lh-3p-filter-input:disabled + .lh-3p-ui-string { text-decoration: line-through; } '));
  v0.append(v1);
...
function createAuditComponent(dom) {
  ...
  v4.append(v5);
  v4.append(dom.document().createTextNode(' '));
...
function createCrcComponent(dom) {
  ...
  v7.append(v8);
  v7.append(dom.document().createTextNode(' '));
  v1.append(v7);
  v0.append(v1);
  return v0;
}
...
function createElementScreenshotComponent(dom) {
  ...
  v5.append(v6);
  v5.append(dom.document().createTextNode(' '));
  v4.append(v5);
  v3.append(v4);
  v2.append(v3);
  v2.append(dom.document().createTextNode(' '));
...
function createFooterComponent(dom) {
  ...
  v6.append(dom.document().createTextNode(' Generated by '));
...
function createGaugePwaComponent(dom) {
  ...
  v8.append(v9);
  v8.append(dom.document().createTextNode(' '));
  ...
  v11.append(v12);
  v11.append(dom.document().createTextNode(' '));
  ...
  v14.append(dom.document().createTextNode(' '));
  ...
  v16.append(v17);
  v16.append(dom.document().createTextNode(' '));
  ...
  v21.append(v22);
  v21.append(dom.document().createTextNode(' '));
  ...
  v24.append(v25);
  v24.append(dom.document().createTextNode(' '));
...
function createOpportunityComponent(dom) {
  ...
  v10.append(v11);
  v9.append(v10);
  v9.append(dom.document().createTextNode(' '));
...
function createTopbarComponent(dom) {
  ...
  v17.append(v18);
  v17.append(dom.document().createTextNode(' '));
  ...
  v28.append(v29);
  v28.append(dom.document().createTextNode(' '));
  ...
  v27.append(v28);
  v26.append(v27);
  v26.append(dom.document().createTextNode(' '));
  ...
  v31.append(v32);
  v31.append(dom.document().createTextNode(' '));
